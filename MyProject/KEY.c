...
{
     /*Get GPIO input Data*/ 
	   KEY_STAT.Key_Scan_Temp = (uint8_t)(((uint16_t)GPIOA->IDR &(1<<8))>>3) | (((uint16_t)GPIOB->IDR & (1<<10))>>10)| (((uint16_t)GPIOB->IDR & (0xE000))>>12) | (((uint16_t)GPIOC->IDR & (1<<6))>>2)| 0xC0;
